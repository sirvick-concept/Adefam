...
const Footer = () => {
  return (
    <footer className="bg-orange-600 text-white pt-14 sm:pt-20 pb-6 px-4 sm:px-6 lg:px-12">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 sm:gap-12">
        ...
        <div>
          ...
          <p className="mt-4 sm:mt-5 text-sm text-white/90 leading-relaxed">
        ...
        <div className="lg:pl-15">
          ...
          <ul className=" space-y-2 sm:space-y-3 text-sm">
            ...
            <li>
              <Link to="/courses" className="hover:text-white/80 transition">
                Courses
              </Link>
            </li>

            <li>
              <Link to="/blog" className="hover:text-white/80 transition">
                Blog
              </Link>
            </li>
      ...
      {/* Bottom Bar */}
      <div className="border-t border-white/20 mt-10 sm:mt-12 pt-5 sm:pt-6 text-center text-xs sm:text-sm text-white/90 px-2">
